...
const styles = StyleSheet.create({
  ...
  header: {
    width: '100%',
    backgroundColor: '#8750ab',
    paddingTop: 55,                 // ensures space from notification bar
    paddingBottom: 25,
    paddingHorizontal: 24,
    borderBottomWidth: 3,           // consistent header border
    borderBottomColor: '#6b21a8',
    alignItems: 'center',
    justifyContent: 'center',
    position: 'absolute',           // keeps header fixed at top
    top: 0,
    left: 0,
    right: 0,
  ...
  content: {
    ...
    paddingTop: 150,                // offsets fixed header height
  ...
  imageContainer: {
    ...
    marginBottom: 12,
    borderWidth: 2,
    borderColor: '#6b21a8',         // consistent border with header
  },
  officeImage: {
    width: 64,
    height: 64,
