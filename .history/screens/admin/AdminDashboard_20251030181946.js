...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    backgroundColor: '#8750ab',       // consistent header color
    borderBottomWidth: 3,             // add fixed border at bottom
    borderBottomColor: '#6b21a8',     // darker tone for contrast
  ...
  headerTitle: {
    ...
    textAlign: 'center',
    marginBottom: 6,
    letterSpacing: 1,                 // improves readability
  },
  headerSubtitle: {
    fontSize: 14,
    color: '#e9d5ff',
  ...
  imageContainer: {
    ...
    marginBottom: 12,
    borderWidth: 2,
    borderColor: '#6b21a8',           // consistent border color with header
  },
  officeImage: {
    width: 64,
    height: 64,
